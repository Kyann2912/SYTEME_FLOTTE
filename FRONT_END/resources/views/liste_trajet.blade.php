...
<body>
    <div class="container-fluid">
        <div class="A mt-5 mb-4">
            <h1 class="text-center text-primary">LISTE DES TRAJETS</h1>
            <hr>

            <!-- Section d'actions -->
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="/trajets/create" class="btn btn-success">AJOUTER UN TRAJET</a>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $trajet['date'] }}</td>
                            <td>{{ $trajet['idchauffeur'] }}</td>
                            <td>{{ $trajet['idvehicule'] }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
